        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 my-10'>
            {
                serviceData.map(({icon,title,description, link}, index) => (
                    <div key={index} className='border border-gray-400 rounded-lg px-8 py-12 hover:shadow-blackCustom cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500'>
